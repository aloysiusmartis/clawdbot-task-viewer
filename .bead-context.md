...
○ clawdbot-task-viewer-j1l · TaskCard: priority pips, timestamps, status styling, hover actions   [● P1 · OPEN]
...
## Research Context
- Current TaskCard has priority as colored border, no timestamps visible
- Auto-Claude uses left-side priority pip, relative timestamps, hover actions
- Status-specific styling: pending=dashed, in_progress=glow, completed=muted
...
- [ ] Status-specific styling (pending=dashed, in_progress=glow, completed=opacity 70%)
...
ACCEPTANCE CRITERIA
- [ ] Priority pip renders correctly
- [ ] Timestamps show relative time
- [ ] Status styling matches spec
- [ ] Hover actions appear for pending
- [ ] Typecheck passes

DEPENDS ON
  → ✓ clawdbot-task-viewer-lla: Dark theme: update CSS tokens ● P1
```
...
- Working directory: /Users/admin/clawd/clawdbot-task-viewer/.worktrees/clawdbot-task-viewer-j1l
- Branch: bead/clawdbot-task-viewer-j1l
- Bead ID: clawdbot-task-viewer-j1l

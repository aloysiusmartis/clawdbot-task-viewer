...
○ clawdbot-task-viewer-ed3 · KanbanColumn: stats header, droppable area   [● P1 · OPEN]
...
## Research Context
- Current: Inline Kanban in App.tsx, no column stats
- Target: Dedicated KanbanColumn component with count, percentage, independent scroll
- Need @hello-pangea/dnd for drag-drop (Droppable)
...
- MODIFY: client/package.json (add @hello-pangea/dnd)

ACCEPTANCE CRITERIA
- [ ] Column shows count and percentage
- [ ] Droppable area works
...
BLOCKS
  ← ○ clawdbot-task-viewer-5e6: App layout: 100vh fixed, DragDropContext, integrate components ● P1
```
